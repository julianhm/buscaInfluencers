    ...
    <form action="nuevoresultado" method="POST" class="register-form pt-2" id="otrabusqueda" name="otrabusqueda" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col sidebar-width">
                   ...
                   <!-- Ocultar paneles izquierdo -->
                    <a class="mobileShow" style="color: #fff;" onclick="hideShowPanel()" href="#">
                    <div class="row">
                        <div class="text-center searched-black-box">
                            <i id='arrowIcon' class="fa fa-angle-up" aria-hidden="true"></i>
                        </div>
                    </div>
                    </a>
                    ...
                    <script>
                        function hideShowPanel() {
                            ...
                            x.classList.toggle("showhidepanel");
                            const element = document.getElementById("arrowIcon");
                            if (element.className == "fa fa-angle-up") {
                    ...
                    <div id="leftPanel">
                        <!-- Panel negro de resultado busqueda -->
                        <div class="row">
                            <div class="px-2 py-3 user-decription searched-black-box">
                                ...
                                <div id="filter_1" class="select_custom_small user-decription-black filter_searched">
                                    <input class="input-modify-searched" type="text" value='<?=$criteriosBusqueda['categoria'];?>' disabled>
                                ...
                                <div id="filter_2" class="select_custom_small user-decription-black filter_searched">
                                    <input class="input-modify-searched" type="text" value='<?=$criteriosBusqueda['redes'];?>' disabled>
                                ...
                                <div id="filter_3" class="select_custom_small user-decription-black filter_searched">
                                    <input class="input-modify-searched" type="text" value='<?=$criteriosBusqueda['cantidad']." seguidores";?>' disabled>
                                ...
                                <div id="filter_4" class="select_custom_small user-decription-black filter_searched">
                                    <input class="input-modify-searched" type="text" value='<?=$criteriosBusqueda['idioma'];?>' disabled>
                                ...
                                <?php foreach ($criteriosBusqueda['pago'] as $key => $pag) { ?>
                                    <div id="<?="filter_5".$pag['idpago']?>" class="select_custom_small user-decription-black filter_searched">
                                        <input class="input-modify-searched" type="text" value='<?=$pag['nombre'];?>' disabled>
                            ...
                            <?php } ?>
                                ...
                                <div id="filter_6" class="select_custom_small user-decription-black filter_searched">
                                    <input class="input-modify-searched" type="text" value='<?=$criteriosBusqueda['pais']."/".$criteriosBusqueda['ciudad'];?>' disabled>
                ...
                <!-- Resultado busqueda -->
                 <div class="col">
                    ...
                    <div id="TableList" ></div>
                                ...
                                <div class="flex-container-search mb-3" id="container"></div>
                                <!-- No working
                                ...
                                function change(page)
                                {
                                    ...
                                    for (var i = (page-1) * obj_per_page; i < (page * obj_per_page); i++) {
                                        ...
                                        "<div style='margin-bottom: 15px;'>"+
                                            ...
                                            "<div>"+                                              
                                                "<img class='img-fluid mb-2' style='width: 135px; height: 135px; border: 1px solid #000; margin-left: auto; margin-right: auto;' src='"+"<?php echo base_url('uploads').'/'?>"+obj[i].foto_perfil+"'>"+
                                            "</div>"+

                                            "<div>"+
                                                "<h6 class='user-decription-black'>"+obj[i].nombreinflu+"<br>"+ obj[i].alias+"<br><div style='border: #000 solid 1px; margin: auto; width: fit-content; padding: 1px 4px; margin-top: 7px;'>"+obj[i].nombrecat +"</div></h6>"+
                                            "</div>"+

                                            "<div>"+
                                                "<a href='"+"<?php echo base_url()?>"+"/perfil/"+obj[i].alias+"' type='button' class='btn btn-ver-perfil btn-sm btn-on-white'>Ver perfil</a>"+
                                            "</div>"+
