                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            ...
                            <form action="<?= route_to('crearnuevanoticiadash') ?>" method="POST" class="form-horizontal"  enctype="multipart/form-data">
                               ...
                               <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label class="form-label user-decription-black"><input type="checkbox" id="esfavorito" name ="esfavorito" value="seleccionado" > Es favorito</label>
                                </div>
                                <div class="mb-3">
                                <label class="form-label user-decription-black"> Esta noticia se relaciona con (Selecciona el titulo de la noticia): </label>
                                    <select name="selectNoticia" id="selectNoticia"class="form-control">
                                    <option value=0 selected>Seleccione una noticia</option>
                                    <?php foreach ($noticias as $key => $m) {?>
                                        <option value=<?=$m['idnoticia']?>><?=$m['titulo'] ?></option>
                                    <?php } ?>   
